...
export default function EmployerSidebar() {
  ...
  return (
    <>
      ...
      <aside
        ref={sidebarRef}
        className={`${styles.sidebar} ${collapsed ? styles.collapsed : ''} ${showDrawer ? styles.show : ''}`}
      >
        ...
        >
          <svg
            className={`${styles.collapseArrow} ${collapsed ? styles.collapseArrowFlipped : ''}`}
            viewBox="0 0 24 24"
            fill="none"
            width="16"
            height="16"
        ...
        <div className={styles.mobileHeader}>
          ...
          <button onClick={() => setShowDrawer(false)} className={styles.closeBtn} aria-label="Close menu">
            <FiX size={24} />
          </button>
        </div>
        ...
        <div className={styles.logoSection}>
          <Link href="/" className={styles.logoLink}>
            <img src="/logo.png" alt="SpellHire" className={styles.logoImage} />
            {!collapsed && <span className={styles.logoText}>SpellHire</span>}
          </Link>
        </div>
        ...
        <div className={styles.bottomSection}>
          ...
          >
            <div className={styles.userAvatar}>
              {profilePictureUrl ? (
                <img src={profilePictureUrl} alt={userName} className={styles.profileImage} />
              ) : (
                userInitials
              )}
            </div>
