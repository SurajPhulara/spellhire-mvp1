            ...
            {currentStep === 3 && (
              <div className="space-y-8 animate-fadeIn">
                ...
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-200 shadow-sm">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        Boost visibility and appear at the top of search results
                      </p>
                    </div>

                    <div className="px-3 py-1 text-xs font-semibold bg-amber-100 text-amber-700 rounded-full border-purple-200">
                      Premium
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between bg-white rounded-xl p-4 border border-purple-200">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Featured jobs receive higher visibility and attract more applicants.
                      </p>
                    </div>
                  ...
                  {formData.isFeatured && (
                    <div className="mt-4 text-xs text-indigo-600 bg-purple-200 rounded-lg px-3 py-2">
                      🚀 This job will be highlighted and prioritized in search results.
                    </div>
                  )}
                </div>
              </div>
            ...
            {currentStep < steps.length - 1 ? (
              ...
              <>
                <button
                  ...
                  name="action"
                  value="save"
                  className="w-full sm:w-auto px-6 md:px-8 py-3 md:py-4 bg-gradient-to-r from-indigo-600 to-indigo-700  text-white rounded-xl font-semibold hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                ...
                <button
                  ...
                  name="action"
                  value="publish"
                  onClick={()=>updateFormData({ status: JobStatus.ACTIVE as JobStatus })}
